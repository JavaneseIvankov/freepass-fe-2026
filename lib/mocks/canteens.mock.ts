...
export const mockCanteens: CanteenDTO[] = [
  {
    ...
    description: 'Traditional Indonesian food and beverages with authentic home-cooked taste',
  ...
  },
  {
    id: generateUUID(),
    name: 'Kantin Barokah',
    description: 'Fast food, snacks, and refreshing drinks for students on the go',
  ...
  },
  {
    id: generateUUID(),
    name: 'Kantin Sehat',
    description: 'Healthy food options with fresh ingredients and nutritious meals',
  ...
  },
  {
    ...
    description: 'Specialty in meatballs and noodle soups with generous portions',
  ...
  },
  {
    id: generateUUID(),
    name: 'Kantin Express',
    description: 'Quick service canteen with affordable prices for busy students',
