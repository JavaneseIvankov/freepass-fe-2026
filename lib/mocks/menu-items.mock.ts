...
import { generateUUID, generateTimestamp, randomNumber, randomBoolean } from './utils';
import { canteenIds } from './canteens.mock';

const foodItems = [
  { name: 'Nasi Goreng Special', description: 'Fried rice with chicken, egg, and vegetables', price: 15000 },
  { name: 'Mie Goreng', description: 'Stir-fried noodles with vegetables and choice of protein', price: 13000 },
  { name: 'Ayam Geprek', description: 'Crispy fried chicken with spicy sambal', price: 18000 },
  { name: 'Nasi Uduk', description: 'Fragrant coconut rice with side dishes', price: 12000 },
  { name: 'Gado-Gado', description: 'Indonesian salad with peanut sauce', price: 10000 },
  { name: 'Soto Ayam', description: 'Traditional chicken soup with rice', price: 14000 },
  { name: 'Bakso', description: 'Meatball soup with noodles', price: 12000 },
  { name: 'Nasi Pecel', description: 'Rice with mixed vegetables and peanut sauce', price: 11000 },
  { name: 'Sate Ayam', description: 'Grilled chicken skewers with peanut sauce', price: 16000 },
  { name: 'Nasi Rawon', description: 'Black beef soup with rice', price: 17000 },
];
